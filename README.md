...
Conventional CPUs use a single-dimensional memory array for program and data space.  Each memory location is assigned a unique numeric identifier known as a memory address.  Being single-dimensional, this memory address is a single numeric range.
